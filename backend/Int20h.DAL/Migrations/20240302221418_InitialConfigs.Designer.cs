...
namespace Int20h.DAL.Migrations
{
    ...
    [Migration("20240302221418_InitialConfigs")]
    partial class InitialConfigs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Int20h.DAL.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5f53458e-f4ef-4b96-a0ac-65726f0344c2"),
                            Name = "admin"
                        },
                        new
                        {
                            Id = new Guid("752e890e-7776-45db-8474-fcf486b12c9c"),
                            Name = "teacher"
                        },
                        new
                        {
                            Id = new Guid("78d0a866-efe5-47b2-bd1b-71ea707b04e3"),
                            Name = "student"
                        });
                });
